...
if TaintedTreasure then
	...
	local CollectibleDesc = {
		...
		[TaintedCollectibles.BASILISK] = {
			Description = "캐릭터와 연결되어 이동하며 적을 따라다니며 접촉한 적에게 공격력 x1.5의 피해를 입힙니다."
		...
		[TaintedCollectibles.LIL_ABYSS] = {
			Description = "대각선으로 돌아다니며 접촉한 적에게 초당 30의 피해를 입힙니다."
		...
		[TaintedCollectibles.SWORD] = {
			Description = "캐릭터가 보는 방향에서 앞뒤로 움직이면서 접촉하는 적에게 초당 1의 피해를 입힙니다."
